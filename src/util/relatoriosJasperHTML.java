 ...
 * @author Acer
 */
public final class relatoriosJasperHTML {
    ...
    public relatoriosJasperHTML(String url, Map parameters, String nomeArquivo) {
        carregarBancoDados();
        this.url = url;
    ...
    public void gerarRelatorios(){
        ...
        try {
            ...
            JRHtmlExporter hmtlExporter = new JRHtmlExporter();
            hmtlExporter.setParameter(JRExporterParameter.JASPER_PRINT, jasperPrint);
            String nome =  System.getProperty("user.dir") + "/orcamento.html";
            hmtlExporter.setParameter(JRExporterParameter.OUTPUT_FILE_NAME, nome);
            hmtlExporter.exportReport();
