...
public class ConsultaVendasTableModel extends AbstractTableModel{
    ...
    private String[] colunas ={"Nome do Cliente", "Data Orçamento", "Fornecedor", "Cidade", "Unidade", "Consultor"};

    public ConsultaVendasTableModel(List<Vieworcamentocurso> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        if (columnIndex==0){
            ...
            return listaVendas.get(rowIndex).getNomeCidade();
