 ...
 * @author Wolverine
 */
public class FrmCadastrarValoresSeguro extends javax.swing.JFrame implements IValoresSeguro{
     ...
     */
    public FrmCadastrarValoresSeguro(UsuarioLogadoBean usuarioLogadoBean, Valoresseguro valores) {
    ...
    private void initComponents() {
        ...
        cobrancajComboBox = new javax.swing.JComboBox();
        jPanel17 = new javax.swing.JPanel();
        jButton5 = new javax.swing.JButton();
        jButton6 = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Cadastrar Valores Seguro Viagem");
        ...
        jLabel8.setText("Cobrança");

        cobrancajComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Diária", "Fixa", "Semana" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(valorExpressjTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel10, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cobrancajComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(cobrancajComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (msg.length() < 5) {
            valoresseguro.setPlano(duracaojTextField.getText());
            valoresseguro.setFornecedorcidade(fornecedorCidade);
            valoresseguro.setValornet(Formatacao.formatarStringfloat(valornetjTextField.getText()));
            valoresseguro.setValorgross(Formatacao.formatarStringfloat(valorgrossjTextField.getText()));
            valoresseguro.setComissaoexpress(Formatacao.formatarStringfloat(valorExpressjTextField.getText()));
            valoresseguro.setComissaopremium(Formatacao.formatarStringfloat(valorPremiumjTextField.getText()));
            Produtosorcamento produto = (Produtosorcamento) produtojComboBox.getSelectedItem();
            valoresseguro.setProdutosorcamento(produto);
            Moedas moeda = (Moedas) moedasVendasjComboBox.getSelectedItem();
            valoresseguro.setMoedas(moeda);
            valoresseguro.setSituacao("Ativo");
            valoresseguro.setCobranca(cobrancajComboBox.getSelectedItem().toString());
            ValorSeguroController valorSeguroController = new ValorSeguroController();
            valorSeguroController.salvar(valoresseguro);
            this.dispose();
        } else {
    ...
    private javax.swing.JComboBox cobrancajComboBox;
    ...
    public void iniciaizarDados(){
        if (valoresseguro!=null){
            duracaojTextField.setText(valoresseguro.getPlano());
            valornetjTextField.setText(Formatacao.formatarFloatString(valoresseguro.getValornet()));
            valornetjTextField.setText(Formatacao.formatarFloatString(valoresseguro.getValorgross()));
            valorExpressjTextField.setText(Formatacao.formatarFloatString(valoresseguro.getComissaoexpress()));
            valorPremiumjTextField.setText(Formatacao.formatarFloatString(valoresseguro.getComissaopremium()));
            produtojComboBox.setSelectedItem(valoresseguro.getProdutosorcamento());
            moedasVendasjComboBox.setSelectedItem(valoresseguro.getMoedas());
            cobrancajComboBox.setSelectedItem(valoresseguro.getCobranca());
        }else {
