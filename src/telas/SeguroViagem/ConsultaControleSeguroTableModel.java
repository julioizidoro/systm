 ...
 * @author Wolverine
 */
public class ConsultaControleSeguroTableModel extends AbstractTableModel{
    
    private List<Viewcontroleseguro> listaVendas;
    private String[] colunas ={"Situação", "Data Inscrição", "Nome Cliente","E-mail", "Telefone", "Unidade", "Consultor","Data Inicio", "Duração"};

    public ConsultaControleSeguroTableModel(List<Viewcontroleseguro> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        }else return listaVendas.get(rowIndex).getNumeroSemanas();
