 ...
 * @author Wolverine
 */
public class ConsultaControleHighSchoolTableModel extends AbstractTableModel{
    ...
    public ConsultaControleHighSchoolTableModel(List<Viewcontrolehighschool> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        }else return listaVendas.get(rowIndex).getPaisIntercambio();
