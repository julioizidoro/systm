 ...
 * @author Wolverine
 */
public class FrmConsultaValoresHighSchool extends javax.swing.JFrame implements IValoresHighSchool{
    
    private ConsultaValoresHighSchoolTableModel modelValor;
    private Fornecedorcidade forncedorCidade;
     ...
     */
    public FrmConsultaValoresHighSchool(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    public FrmConsultaValoresHighSchool(UsuarioLogadoBean usuarioLogadoBean, IOrcamentoProduto telaOrcamentoProduto) {
        this.usuarioLogadoBean = usuarioLogadoBean;
        this.telaOrcamentoProduto = telaOrcamentoProduto;
        initComponents();
        URL url = this.getClass().getResource("/imagens/logo/logotela.png");
    ...
    public FrmConsultaValoresHighSchool(UsuarioLogadoBean usuarioLogadoBean, Fornecedorcidade fornecedorCidade, IHighSchool telaHighSchool) {
        this.usuarioLogadoBean = usuarioLogadoBean;
        ...
        this.setIconImage(imagemTitulo);
        this.setLocationRelativeTo(null);
        setFornecedor(fornecedorCidade);
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Valores High School");
        ...
        AdicionarjButton3.setToolTipText("Novo valor highschool");
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolAdicionar()==1){
            new FrmCadastrarValoresHighSchool(usuarioLogadoBean, null);
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolEditar()== 1) {
            ...
            if (linha >= 0) {
                ...
                Valoreshighschool valoreshighschool = valorHighSchoolController.consultar(listaValor.get(linha).getIdvaloresHighSchool());
                if (valoreshighschool!=null){
                    new FrmCadastrarValoresHighSchool(usuarioLogadoBean, valoreshighschool);
                }else JOptionPane.showMessageDialog(rootPane, "Valor do High School não encontrado");
            }
        } else {
    ...
    private void situacaojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_situacaojButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolSituacao()== 1) {
            int linha = valorjTable.getSelectedRow();
            if (linha >= 0) {
                ValorHighSchoolController valorHighSchoolController = new ValorHighSchoolController();
                Valoreshighschool valoreshighschool = valorHighSchoolController.consultar(listaValor.get(linha).getIdvaloresHighSchool());
                if (valoreshighschool!=null){
                    valoreshighschool.setSituacao("Inativo");
            ...
            if (linha>=0){
                ...
                if (valoreshighschool!=null){
                    if (telaHighSchool!=null){
                        telaHighSchool.setValores(valoreshighschool);
                        this.dispose();
                    }else if (telaOrcamentoProduto!=null){
                        telaOrcamentoProduto.setFornecedor(forncedorCidade.getFornecedor(), valoreshighschool.getDuracao(), valoreshighschool.getValorgross());
                        this.dispose();
                    }                    
                }else JOptionPane.showMessageDialog(rootPane, "Valores não localizado");
            }
        }else {
    ...
    public void setFornecedor(Fornecedorcidade fornecedorCidade) {
        if (fornecedorCidade!=null){
            this.forncedorCidade= fornecedorCidade;
    ...
    public void setModel() {
        if (forncedorCidade != null) {
            ValorHighSchoolController valorHighSchoolController = new ValorHighSchoolController();
            listaValor = valorHighSchoolController.listarConsulta(forncedorCidade.getIdfornecedorcidade());
            if (listaValor == null) {
                listaValor = new ArrayList<Viewconsultavaloreshighschool>();
            }
            modelValor = new ConsultaValoresHighSchoolTableModel(listaValor);
            ...
            valorjTable.getColumnModel().getColumn(2).setCellRenderer(rendererValor);
            valorjTable.getColumnModel().getColumn(2).setPreferredWidth(80);
            valorjTable.getColumnModel().getColumn(3).setPreferredWidth(50);
            valorjTable.getColumnModel().getColumn(4).setPreferredWidth(80);
            valorjTable.repaint();
        }
    }
}
