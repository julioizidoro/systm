 ...
 * @author Wolverine
 */
public class FrmConsultarLadies extends javax.swing.JFrame implements IConsultaLadies{
     ...
     */
    public FrmConsultarLadies(UsuarioLogadoBean usuarioLogadoBean, List<Cambio> listaCambio) {
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Fichas de Programas Ladies");
        ...
        AdicionarjButton3.setToolTipText("Nova Ficha de Programa Ladies");
        ...
        EditarjButton.setToolTipText("Editar Ficha de Programa Ladies");
        ...
        excluirjButton.setToolTipText("Cancelar Ficha de Programa Ladies");
        ...
        imprimirjButton1.setToolTipText("Pesquisar Ficha Ladies");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(numeroFichasjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getLadiesAdicionar()==1){
            if (listaCambio!=null){
                new FrmFichaLadies(0, usuarioLogadoBean, this, listaCambio.get(0).getData());
            }else {
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getLadiesEditar() == 1) {
            ...
            if (linha >= 0) {
                new FrmFichaLadies(listaVendas.get(linha).getIdVendas(), usuarioLogadoBean, this, listaCambio.get(0).getData());
            }
        } else {
        ...
        if (usuarioLogadoBean.getAcesso().getLadiesExcluir() == 1) {
            ...
            if (linha >= 0) {
                ...
                if (resultado) {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Ficha de Ladies Cancelada");
    ...
    private void nomeClientejTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nomeClientejTextFieldKeyPressed
        ...
        if (evt.getKeyCode() == evt.VK_F1) {
            ...
            for (int i = 0; i < listaVendas.size(); i++) {
                Controleladies controle = ladiesController.consultarControleLadies(listaVendas.get(i).getIdVendas());
                if (controle == null) {
                    ...
                    invoice.setControle(controle.getIdcontroleLadies());
                    invoice.setProdutos(8);
    ...
    public void carregarModelVendas(){
        ...
        String sql = null;
         ...
         if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            sql = "Select v from Viewvendasladies v where v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' and v.situacao<>'Cancelada' order by v.dataVenda";
        }else {
            sql = "Select v from Viewvendasladies v where v.idunidadeNegocio=" + usuarioLogadoBean.getUnidadeNegocio().getIdunidadeNegocio() +  
                    " and v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' and v.situacao<>'Cancelada' order by v.dataVenda";
        }
        LadiesController ladiesController = new LadiesController();
        listaVendas = ladiesController.listaViewVendasLadies(sql);
        if (listaVendas==null){
            listaVendas = new ArrayList<Viewvendasladies>();
        }
    ...
    public void excluirLadies(int idVenda){
        LadiesController ladiesController = new LadiesController();
        Ladies ladies = ladiesController.consultarLadies(idVenda);
        if (ladies!=null){
            Controleladies controle = ladiesController.consultarControleLadies(ladies.getIdladies());
            if (controle!=null){
                ladiesController.excluirControleLadies(controle);
            }
            ladiesController.excluir(ladies.getIdladies());
        }
    }
    ...
    public void imprimirFichaLadies(){
    ...
    public void imprimirContratoLadies(){
    ...
    public void setPesquisa(Cliente cliente, Unidadenegocio unidade, Usuario usuario, Date dataInicial, Date dataFinal, String situacao) {
        String sql = null;
        sql = "Select v from Viewvendasladies v where ";
