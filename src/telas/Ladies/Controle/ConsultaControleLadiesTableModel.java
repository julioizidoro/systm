 ...
 * @author Wolverine
 */
public class ConsultaControleLadiesTableModel extends AbstractTableModel{
    
    private List<Viewcontroleladies> listaVendas;
    ...
    public ConsultaControleLadiesTableModel(List<Viewcontroleladies> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        }else return listaVendas.get(rowIndex).getPais();
