...
//        String caminho = "/telas/contas/boletotemplatetravelmate.pdf";
//        caminho = servletContext.getRealPath(caminho); 
//        byte[] pdf = BoletoViewer.groupInOnePdfWithTemplate(listaBoletos, caminho);
//        enviarBoleto(pdf);
//    }
//    
//    public void gerarBoletoPDF(Boleto boleto, String nome){
//         BoletoViewer boletoViewer = new BoletoViewer(boleto);
//         File arquivoPdf = boletoViewer.getPdfAsFile(nome + ".pdf");
