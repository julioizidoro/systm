...
public class ConsultaVendasTableModel extends AbstractTableModel{
    ...
    private String[] colunas ={"Situação", "Nome do Cliente", "Data Inscrição", "Tipo Work", "Unidade", "Consultor"};

    public ConsultaVendasTableModel(List<Viewvendasworktravel> listaVendas) {
