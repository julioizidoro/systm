 ...
 * @author Wolverine
 */
public class FrmConsultaValoresWork extends javax.swing.JFrame implements IValoresWork{
    
    private ConsultaValoresWorkTableModel modelValor;
     ...
     */
    public FrmConsultaValoresWork(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    public FrmConsultaValoresWork(UsuarioLogadoBean usuarioLogadoBean, IWorkTravel telaWork) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    public FrmConsultaValoresWork(UsuarioLogadoBean usuarioLogadoBean, IOrcamentoProduto telaOrcamentoProduto) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Valores Work and Travel");
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolAdicionar()==1){
            new FrmCadastrarValoresWork(usuarioLogadoBean, null);
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolEditar()== 1) {
            ...
            if (linha >= 0) {
                ...
                Valoreswork valoresWork = valorWorkController.consultar(listaValor.get(linha).getIdvaloresWork());
                if (valoresWork!=null){
                    new FrmCadastrarValoresWork(usuarioLogadoBean, valoresWork);
    ...
    private void valorjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valorjTableMouseClicked
        if (evt.getClickCount()==2){
            ...
            if (linha>=0){
                ...
                if (valoresWork!=null){
                    if (telaWork!=null){
                        telaWork.setValores(valoresWork);
                        this.dispose();
                    }else if (telaOrcamentoProduto!=null){
                        telaOrcamentoProduto.setFornecedor(fornecedorCidade.getFornecedor(), valoresWork.getDescricao(), valoresWork.getValorgross());
                        this.dispose();
                    }
    ...
    private void situacaojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_situacaojButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchool()== 1) {
            ...
            if (linha >= 0) {
                ...
                Valoreswork valoreswork = valorWorkController.consultar(listaValor.get(linha).getIdvaloresWork());
                if (valoreswork!=null){
                    valoreswork.setSituacao("Inativo");
    ...
    public void setModel() {
        if (fornecedorCidade != null) {
            ValorWorkController valorWorkController = new ValorWorkController();
            listaValor = valorWorkController.listarConsulta(fornecedorCidade.getIdfornecedorcidade());
            if (listaValor == null) {
                listaValor = new ArrayList<Viewconsultavaloreswork>();
            }
            modelValor = new ConsultaValoresWorkTableModel(listaValor);
