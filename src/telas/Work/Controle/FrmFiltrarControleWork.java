 ...
 * @author Wolverine
 */
public class FrmFiltrarControleWork extends javax.swing.JFrame implements IControleWork{
     ...
     */
    public FrmFiltrarControleWork(UsuarioLogadoBean usuarioLogadoBean, IControleWork telaControleWork) {
...
programajComboBox = new javax.swing.JComboBox();
...
setTitle(" Filtrar Controle de Work and Travel");
...
jButton1.addActionListener(new java.awt.event.ActionListener() {
    ...
    jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Programa"));

    programajComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nenhum", "Independent", "Premium" }));
    ...
    jPanel2Layout.setHorizontalGroup(
        ...
        .addGroup(jPanel2Layout.createSequentialGroup()
            .addContainerGap()
            .addComponent(programajComboBox, 0, 226, Short.MAX_VALUE)
            .addContainerGap())
    );
    jPanel2Layout.setVerticalGroup(
        ...
        .addGroup(jPanel2Layout.createSequentialGroup()
            .addContainerGap()
            .addComponent(programajComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        this.telaControleWork.setFiltrarControleWork(cliente, unidadeNegocio, dataPrevisaoIniciojDateChooser.getDate(), dataPrevisaoFinaljDateChooser.getDate()
                , programajComboBox.getSelectedItem().toString(), situacaojComboBox.getSelectedItem().toString(), idConsultor);
        this.dispose();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        this.telaControleWork.cancelarFiltroCurso();
        this.dispose();
    ...
    private javax.swing.JComboBox programajComboBox;
