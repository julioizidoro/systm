 ...
 * @author Wolverine
 */
public class ConsultaControleWorkTableModel extends AbstractTableModel{
    
    private List<Viewcontrolework> listaVendas;
    private String[] colunas ={"Situação", "Data Embarque", "Data Inscrição", "Nome Cliente","E-mail", "Telefone", "Unidade", "Consultor", "Programa", "Sponsor"};

    public ConsultaControleWorkTableModel(List<Viewcontrolework> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        if (columnIndex==0){
            ...
            return listaVendas.get(rowIndex).getTipo();
        }else return listaVendas.get(rowIndex).getSponsor();
