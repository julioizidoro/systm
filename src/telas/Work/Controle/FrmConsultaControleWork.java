 ...
 * @author Wolverine
 */
public class FrmConsultaControleWork extends javax.swing.JFrame implements  IControleWork{
    
    private ConsultaControleWorkTableModel modelVendas;
     ...
     */
    public FrmConsultaControleWork(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    private void initComponents() {
        ...
        setTitle("Controle de Work and Travel");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nomeClientejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getPcwtatualizar()==1){
            int linha = vendasCursojTable.getSelectedRow();
            if (linha>=0){
                new FrmAtulizarControleWork(listaVendas.get(linha), usuarioLogadoBean);
            }
    ...
    private void imprimirjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton1ActionPerformed
        new FrmFiltrarControleWork(usuarioLogadoBean, this);
    ...
    private void imprimirjButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton2ActionPerformed
        if (usuarioLogadoBean.getAcesso().getPcwtfinalizar()==1){
            int linha =vendasCursojTable.getSelectedRow();
            if (linha>=0){
                WorkTravelController workTravelController = new WorkTravelController();
                Worktravel work = workTravelController.consultarWorktravel(listaVendas.get(linha).getIdVendas());
                if (work!=null){
                    work.setControle("Finalizado");
                    workTravelController.salvar(work);
                }
                Controlework controle = workTravelController.consultarControleWork(listaVendas.get(linha).getIdVendas());
                if (controle!=null){
    ...
    private void imprimirjButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton6ActionPerformed
        if (usuarioLogadoBean.getAcesso().getInvoiceLancar() == 1) {
            ...
            if (linha >= 0) {
                ...
                new FrmCadastrarInvoiceController(listaVendas.get(linha).getIdVendas(), listaVendas.get(linha).getNomeCliente(), listaVendas.get(linha).getNomeFornecedor(), listaVendas.get(linha).getNomeFantasia(), "Work and Travel", parametrosprodutos.getWork(), listaVendas.get(linha).getIdcontroleWork());
            }
        }else JOptionPane.showMessageDialog(rootPane, "Acesso Negado");
...
public void carregarModelVendas(){
        ...
        if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            sql = "Select v from Viewcontrolework  v where v.controle<>'Finalizado' and situacao<>'Cancelado' and v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' ";
        }else {
            sql = "Select v from Viewcontrolework v where v.controle<>'Finalizado' and v.idUnidadeNegocio=" + usuarioLogadoBean.getUnidadeNegocio().getIdunidadeNegocio() + " and situacao<>'Cancelado' and v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' ";
        }
        if (numero==0){
        ...
        WorkTravelController workTravelController = new WorkTravelController();
        listaVendas = workTravelController.consultaControleWork(sql);
        if (listaVendas==null){
            listaVendas = new ArrayList<Viewcontrolework>();
        }
        modelVendas = new ConsultaControleWorkTableModel(listaVendas);
    ...
    public void setFiltrarControleWork(Cliente cliente, Unidadenegocio unidadeNegocio, Date dataInicioPrevista, Date dataTerminoPrevista, String programa, String situacao, int idConsultor) {
        ...
        sql = "Select v from Viewcontrolework v where ";
        if (cliente!=null){
        ...
        if (programa!=null){
            if (condicao){
                sql = sql + " and v.tipo='" + programa +"' ";
            }else {
                sql = sql + " v.tipo='" + programa +"' ";
                condicao=true;
            }
    ...
    public void exportarExcel(String caminho, String nomeArquivo) {
        ...
        workTravelController.ExportarExcel(nomeArquivo, local, porta, senha, banco, usuario, caminho, idunidade);
    }
    ...
    public void setDocAnexado(String tipoArquivo, int idVenda, int idControle) {
        WorkTravelController workTravelController = new WorkTravelController();
        Controlework controle;
        if (tipoArquivo.equalsIgnoreCase("Ficha Assinada")) {
            controle = workTravelController.consultarControleWork(idVenda);
            if (controle != null) {
