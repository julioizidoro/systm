 ...
 * @author Wolverine
 */
public class FrmConsultaValoresTrainee extends javax.swing.JFrame implements IValoresTrainee{
    
    private ConsultaValoresTraineeTableModel modelValor;
     ...
     */
    public FrmConsultaValoresTrainee(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    public FrmConsultaValoresTrainee(UsuarioLogadoBean usuarioLogadoBean, ITrainee telaTrainee) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    public FrmConsultaValoresTrainee(UsuarioLogadoBean usuarioLogadoBean, IOrcamentoProduto telaOrcamentoProduto) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Valores Trainee");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        new FrmConsultaFornecedor(usuarioLogadoBean, this, parametrosprodutos.getTrainee());
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolAdicionar()==1){
            new FrmCadastrarValoresTrainee(usuarioLogadoBean, null);
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolEditar()== 1) {
            ...
            if (linha >= 0) {
                if (listaValor.get(linha)!=null){
                    new FrmCadastrarValoresTrainee(usuarioLogadoBean, listaValor.get(linha));
    ...
    private void valorjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valorjTableMouseClicked
        if (evt.getClickCount()==2){
            ...
            if (linha>=0){
                if (listaValor.get(linha)!=null){
                    if (telaTrainee!=null){
                        telaTrainee.setValores(listaValor.get(linha));
                        this.dispose();
                    }else if (telaOrcamentoProduto!=null){
                        //telaOrcamentoProduto.setFornecedor(fornecedorCidade.getFornecedor(), Valorestrainee.getDescricao(), valoresWork.getValorgross());
                        this.dispose();
                    }
    ...
    private void situacaojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_situacaojButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchool() == 1) {
            ...
            if (linha >= 0) {
                ...
                valorTraineeController.salvar(listaValor.get(linha));
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Acesso Negado");
        }
    ...
    public void setModel() {
        if (fornecedorCidade != null) {
            ValorTraineeController valorTraineeController = new ValorTraineeController();
            listaValor = valorTraineeController.listar(fornecedorCidade.getFornecedor().getIdfornecedor());
            if (listaValor == null) {
                listaValor = new ArrayList<Valorestrainee>();
            }
            modelValor = new ConsultaValoresTraineeTableModel(listaValor);
