 ...
 * @author Wolverine
 */
public class ConsultaControleTraineeTableModel extends AbstractTableModel{
    
    private List<Viewcontroletrainee> listaVendas;
    private String[] colunas ={"Situação", "Doc", "Data Embarque", "Data Inscrição", "Nome Cliente","E-mail", "Idade", "Telefone", "Unidade", "Consultor"};
    
    public ConsultaControleTraineeTableModel(List<Viewcontroletrainee> listaVendas) {
