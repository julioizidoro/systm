 ...
 * @author Wolverine
 */
public class ConsultaControleVistosTableModel extends AbstractTableModel{
    
    private List<Viewcontrolevistos> listaVendas;
    private String[] colunas ={"Situação", "Data Inscrição", "Nome Cliente","E-mail", "Telefone", "Unidade", "Consultor"," Data Programa", " País do Visto"};

    public ConsultaControleVistosTableModel(List<Viewcontrolevistos> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        if (columnIndex==0){
            ...
            return listaVendas.get(rowIndex).getDataInicioPrograma();
        }else return listaVendas.get(rowIndex).getPaisVisto();
