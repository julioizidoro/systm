 ...
 * @author Wolverine
 */
public class FrmConsultaValoresVistos extends javax.swing.JFrame implements IValoresVistos{
    
    private ConsultaValoresVistosTableModel modelValor;
     ...
     */
    public FrmConsultaValoresVistos(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    public FrmConsultaValoresVistos(UsuarioLogadoBean usuarioLogadoBean, IVistos telaVistos) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Valores Vistos");
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolAdicionar()==1){
            new FrmCadastrarValoresVistos(usuarioLogadoBean, null);
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolEditar() == 1) {
            ...
            if (linha >= 0) {
                new FrmCadastrarValoresVistos(usuarioLogadoBean, listaValor.get(linha));
            }
        } else {
    ...
    private void valorjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valorjTableMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (linha >= 0) {
                if (telaVistos != null) {
                    telaVistos.setValores(listaValor.get(linha));
                     this.dispose();
                }
            } else {
    ...
    private void situacaojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_situacaojButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchool() == 1) {
            ...
            if (linha >= 0) {
                ...
                vistosController.salvar(listaValor.get(linha));
                setModel();
            } else {
                JOptionPane.showMessageDialog(rootPane, "Acesso Negado");
            }
    ...
    public void setModel() {
        VistosController vistosController = new VistosController();
        listaValor = vistosController.listar();
        if (listaValor == null) {
            listaValor = new ArrayList<Valoresvistos>();
        }
        modelValor = new ConsultaValoresVistosTableModel(listaValor);
        ...
        valorjTable.getColumnModel().getColumn(0).setPreferredWidth(100);
        valorjTable.getColumnModel().getColumn(1).setPreferredWidth(200);
