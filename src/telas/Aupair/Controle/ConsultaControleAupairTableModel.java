 ...
 * @author Wolverine
 */
public class ConsultaControleAupairTableModel extends AbstractTableModel{
    
    private List<Viewcontroleaupair> listaVendas;
    private String[] colunas ={"Situação", "Data Embarque", "Data Inscrição", "Nome Cliente","E-mail", "Telefone", "Unidade", "Consultor", "Sponsor"};

    public ConsultaControleAupairTableModel(List<Viewcontroleaupair> listaVendas) {
