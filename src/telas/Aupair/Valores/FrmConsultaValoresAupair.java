 ...
 * @author Wolverine
 */
public class FrmConsultaValoresAupair extends javax.swing.JFrame implements IValoresAupair{
    
    private ConsultaValoresAupairTableModel modelValor;
     ...
     */
    public FrmConsultaValoresAupair(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    public FrmConsultaValoresAupair(UsuarioLogadoBean usuarioLogadoBean, IAupair telaAupair) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    public FrmConsultaValoresAupair(UsuarioLogadoBean usuarioLogadoBean, IOrcamentoProduto telaOrcamentoProduto) {
        this.usuarioLogadoBean = usuarioLogadoBean;
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Valores Aupair");
        ...
        AdicionarjButton3.setToolTipText("Novo valor au pair");
        ...
        EditarjButton.setToolTipText("Editar Valor Au Pair");
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolAdicionar()==1){
            new FrmCadastrarValoresAupair(usuarioLogadoBean, null);
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchoolEditar()== 1) {
            ...
            if (linha >= 0) {
                ValorAupairController valorAuapirController = new ValorAupairController();
                Valoresaupair valoresAupair = valorAuapirController.consultar(listaValor.get(linha).getIdvaloresAupair());
                if (valoresAupair!=null){
                    new FrmCadastrarValoresAupair(usuarioLogadoBean, valoresAupair);
                }else JOptionPane.showMessageDialog(rootPane, "Valor do Work não encontrado");
            }
        } else {
    ...
    private void valorjTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_valorjTableMouseClicked
        if (evt.getClickCount()==2){
            ...
            if (linha>=0){
                ...
                Valoresaupair valoresAupair = valorAupairController.consultar(listaValor.get(linha).getIdvaloresAupair());
                if (valoresAupair!=null){
                    if (telaAupair!=null){
                        telaAupair.setValores(valoresAupair);
                        this.dispose();
                    }else if (telaOrcamentoProduto!=null){
                        telaOrcamentoProduto.setFornecedor(fornecedorCidade.getFornecedor(), valoresAupair.getDescricao(), valoresAupair.getValorgross());
                        this.dispose();
                    }
    ...
    private void situacaojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_situacaojButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getValorHighSchool()== 1) {
            ...
            if (linha >= 0) {
                ...
                Valoresaupair valoresaupair = valorAupairController.consultar(listaValor.get(linha).getIdvaloresAupair());
                if (valoresaupair!=null){
                    valoresaupair.setSituacao("Inativo");
    ...
    public void setModel() {
        if (fornecedorCidade != null) {
            ValorAupairController valorAupairController = new ValorAupairController();
            listaValor = valorAupairController.listarConsulta(fornecedorCidade.getIdfornecedorcidade());
            if (listaValor == null) {
                listaValor = new ArrayList<Viewconsultavaloresaupair>();
            }
            modelValor = new ConsultaValoresAupairTableModel(listaValor);
