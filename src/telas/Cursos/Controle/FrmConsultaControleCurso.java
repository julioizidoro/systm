 ...
 * @author Wolverine
 */
public class FrmConsultaControleCurso extends javax.swing.JFrame implements  IControleCurso{
    
    private ConsultaControleCursosTableModel modelVendas;
     ...
     */
    public FrmConsultaControleCurso(UsuarioLogadoBean usuarioLogadoBean) {
    ...
    private void initComponents() {
        ...
        alteracoesjButton1 = new javax.swing.JButton();
        ...
        imprimirjButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/botoes/bt_systm_duplicar.png"))); // NOI18N
        imprimirjButton7.setText("Duplicar");
        imprimirjButton7.setToolTipText("Pesquisar ");
        imprimirjButton7.setFocusable(false);
        imprimirjButton7.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        imprimirjButton7.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        imprimirjButton7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                imprimirjButton7ActionPerformed(evt);
            }
        });
        BarradeTarefasjToolBar3.add(imprimirjButton7);
        ...
        alteracoesjButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/botoes/HISTORICO DE DADOS.png"))); // NOI18N
        alteracoesjButton1.setText("Alterações");
        alteracoesjButton1.setToolTipText("Alterações");
        alteracoesjButton1.setFocusable(false);
        alteracoesjButton1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        alteracoesjButton1.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        alteracoesjButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                alteracoesjButton1ActionPerformed(evt);
            }
        });
        BarradeTarefasjToolBar3.add(alteracoesjButton1);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(tabelajScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(BarradeTarefasjToolBar3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getPccatualizar()==1){
            ...
            if (linha>=0){
                new FrmAtulizarControleCurso(listaVendas.get(linha), usuarioLogadoBean);
            }
    ...
    private void imprimirjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton1ActionPerformed
        new FrmFiltrarControleCurso(usuarioLogadoBean, this);
...
//                if (invoices!=null){
//                    invoices.setControle(listaVendas.get(i).getIdcontroleCursos());
...
//        }
        ...
        if (usuarioLogadoBean.getAcesso().getPccfinalizar() == 1) {
            ...
            if (resultado) {
                ...
                if (linha >= 0) {
                    ...
                    Cursos curso = cursosController.consultarCursos(listaVendas.get(linha).getIdVendas());
                    if (curso != null) {
                        curso.setControle("Finalizado");
                        cursosController.salvar(curso);

                    }
                    Controlecursos controle = cursosController.consultarControleCursos(listaVendas.get(linha).getIdVendas(), listaVendas.get(linha).getIdcontroleCursos());
                    if (controle != null) {
    ...
    private void imprimirjButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton4ActionPerformed
        if (usuarioLogadoBean.getAcesso().getUploadArquivo() == 1) {
            int linha = vendasCursojTable.getSelectedRow();
            if (linha >= 0) {
                new FrmConsultaArquivos(usuarioLogadoBean, listaVendas.get(linha).getIdVendas(), listaVendas.get(linha).getNomeCliente(), listaVendas.get(linha).getIdcontroleCursos(), listaVendas.get(linha).getIdunidadeNegocio(), this);
            } else {
    ...
    private void imprimirjButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton6ActionPerformed
        if (usuarioLogadoBean.getAcesso().getInvoiceLancar() == 1) {
            int linha = vendasCursojTable.getSelectedRow();
            if (linha >= 0) {
                new FrmCadastrarInvoiceController(listaVendas.get(linha).getIdVendas(), listaVendas.get(linha).getNomeCliente(), listaVendas.get(linha).getNomefornecedor(), listaVendas.get(linha).getNomeFantasia(), "Cursos", usuarioLogadoBean.getParametrosprodutos().getCursos(), listaVendas.get(linha).getIdcontroleCursos());
            }
        }else JOptionPane.showMessageDialog(rootPane, "Acesso Negado");
    ...
    private void imprimirjButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirjButton7ActionPerformed
        ...
        if (linha>=0){
            ...
            Controlecursos controle = cursosController.consultarControleCursos(listaVendas.get(linha).getIdVendas(), listaVendas.get(linha).getIdcontroleCursos());
            if (controle!=null){
                Controlecursos novoControle = new Controlecursos();
                novoControle.setDataEmbarque(controle.getDataEmbarque());
                novoControle.setDataEnvioInscricaoEscola(controle.getDataEnvioInscricaoEscola());
                novoControle.setDocanexado(controle.getDocanexado());
                novoControle.setKitViagem(controle.getKitViagem());
                novoControle.setLoasObs(controle.getLoasObs());
                novoControle.setOrientacaoPreEmbarque(controle.getOrientacaoPreEmbarque());
                novoControle.setPagamentoAcomodacao(controle.getPagamentoAcomodacao());
                novoControle.setPossuiAcomidacao(controle.getPossuiAcomidacao());
                novoControle.setPrevisaoPagamentoAcomodacao(controle.getPrevisaoPagamentoAcomodacao());
                novoControle.setSituacao(controle.getSituacao());
                novoControle.setValorAcomodacao(controle.getValorAcomodacao());
                novoControle.setVendas(controle.getVendas());
                novoControle.setVisto(controle.getVisto());
                novoControle.setWork(controle.getWork());
                novoControle = cursosController.salvar(novoControle);
                ...
                salvarInvoice(novoControle.getVendas(), novoControle.getIdcontroleCursos(), parametrosprodutos.getCursos());
                JOptionPane.showMessageDialog(rootPane, "Dados do controle duplicado com sucesso");
                setModel();
            }
        }
    ...
    private void alteracoesjButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alteracoesjButton1ActionPerformed
        new FrmHistoricoAlteracoes();
    }//GEN-LAST:event_alteracoesjButton1ActionPerformed
    ...
    private javax.swing.JButton alteracoesjButton1;
...
public void carregarModelVendas(){
        ...
        if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            sql = "Select v from Viewcontrolecursos v where v.controle<>'Finalizado' and v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' ";
        }else {
            sql = "Select v from Viewcontrolecursos v where v.controle<>'Finalizado' and v.idunidadeNegocio=" + usuarioLogadoBean.getUnidadeNegocio().getIdunidadeNegocio() + " and v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' ";
        }
        if (numero==0){
            ...
            order = " order by v.nomefornecedor";
        }
        if (order!=null){
            sql = sql + order;
        }
        CursosController cursosController = new CursosController();
        listaVendas = cursosController.consultaControleCursos(sql);
        if (listaVendas==null){
            listaVendas = new ArrayList<Viewcontrolecursos>();
        }
        modelVendas = new ConsultaControleCursosTableModel(listaVendas);
...
//        };
        ...
        vendasCursojTable.getColumnModel().getColumn(6).setPreferredWidth(300);
        vendasCursojTable.getColumnModel().getColumn(7).setPreferredWidth(200);
        vendasCursojTable.getColumnModel().getColumn(8).setPreferredWidth(100);
        vendasCursojTable.getColumnModel().getColumn(9).setPreferredWidth(100);
        vendasCursojTable.getColumnModel().getColumn(10).setPreferredWidth(200);
        vendasCursojTable.getColumnModel().getColumn(11).setPreferredWidth(200);
    ...
    public void setFiltrarControleCurso(Cliente cliente, Fornecedorcidade fornecedorCidade, String pais, Date dataEmbarqueInicial, Date dataEmbarqueFinal, Date dataPosicaoInicial, Date dataPosicaoFinal, String situacao, int idConsultor, Unidadenegocio unidadeNegocio) {
        ...
        sql = "Select v from Viewcontrolecursos v where ";
        if (cliente!=null){
        ...
        if (fornecedorCidade!=null){
            if (condicao){
                sql = sql + " and v.idfornecedorcidade=" + fornecedorCidade.getIdfornecedorcidade() + " ";
            }else {
                sql = sql + " v.idfornecedorcidade=" + fornecedorCidade.getIdfornecedorcidade() + " ";
                condicao = true;
            }
        }
        if (pais.length()>0){
        ...
        if (dataEmbarqueInicial!=null){
            if (condicao){
                sql = sql + " and v.dataEmbarque>='" + Formatacao.ConvercaoDataSql(dataEmbarqueInicial) + 
                    "' and  v.dataEmbarque<='" + Formatacao.ConvercaoDataSql(dataEmbarqueFinal) + "' ";
            }else {
                sql = sql + " v.dataEmbarque>='" + Formatacao.ConvercaoDataSql(dataEmbarqueInicial) + 
                    "' and  v.dataEmbarque<='" + Formatacao.ConvercaoDataSql(dataEmbarqueFinal) + "' ";
                condicao = true;
            }
            
        }
//        if (dataPosicaoInicial!=null){
//            if (condicao){
//                sql = sql + " and v.dataPrevistaPagamento>='" + Formatacao.ConvercaoDataSql(dataPosicaoInicial) + 
//                    "' and  v.dataPrevistaPagamento<='" + Formatacao.ConvercaoDataSql(dataPosicaoFinal) + "' ";
//            }else {
//                sql = sql + "  v.dataPrevistaPagamento>='" + Formatacao.ConvercaoDataSql(dataPosicaoInicial) + 
//                    "' and  v.dataPrevistaPagamento<='" + Formatacao.ConvercaoDataSql(dataPosicaoFinal) + "' ";
//                condicao=true;
//            }
//            
//        }
    ...
    public void exportarExcel(String caminho, String nomeArquivo) {
        ...
        cursosController.ExportarExcel(nomeArquivo, local, porta, senha, banco, usuario, caminho, idunidade);
    }
        ...
        if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            if (usuarioLogadoBean.getUnidadeNegocio().getDataembarcadocurso()!=null){
                ...
                if (!dataUnidade.equalsIgnoreCase(dataSistema)){
                    CursosController cusosController = new CursosController();
                    cusosController.gerarSitaucaoEmbarcado();
                    gerarFinalizados();
    ...
    public void gerarFinalizados(){
        String sql = "Select v from Viewcontrolecursos v where v.situacao='Embarcado' and v.dataTermino<'" + 
                Formatacao.ConvercaoDataSql(new Date()) + "'";
        CursosController cursosController = new CursosController();
        List<Viewcontrolecursos> listaEmbarcados = cursosController.consultaControleCursos(sql);
        if (listaEmbarcados!=null){
            for (int i=0;i<listaEmbarcados.size();i++){
                Controlecursos controle = cursosController.consultarControleCursos(listaEmbarcados.get(i).getIdVendas(), listaEmbarcados.get(i).getIdcontroleCursos());
                if (controle!=null){
                    controle.setSituacao("Finalizado");
                    cursosController.salvar(controle);
                }
                Cursos curso = cursosController.consultarCursos(listaEmbarcados.get(i).getIdVendas());
                if (curso!=null){
                    curso.setControle("Finalizado");
                    cursosController.salvar(curso);
                }
    ...
    public void setDocAnexado(String tipoArquivo, int idVenda, int idControle) {
        CursosController cursosController = new CursosController();
        Controlecursos controle;
        if (tipoArquivo.equalsIgnoreCase("Ficha Assinada")) {
             controle = cursosController.consultarControleCursos(idVenda, idControle);
            if (controle != null) {
