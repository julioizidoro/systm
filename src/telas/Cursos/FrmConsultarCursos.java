 ...
 * @author Wolverine
 */
public class FrmConsultarCursos extends javax.swing.JFrame implements IConsultaCursos{
     ...
     */
    public FrmConsultarCursos(UsuarioLogadoBean usuarioLogadoBean, List<Cambio> listaCambio) {
    ...
    private void initComponents() {
        ...
        numerosjButton = new javax.swing.JButton();
        ...
        setTitle("Consulta Fichas de Cursos");
        ...
        numerosjButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/botoes/VER DADOS.png"))); // NOI18N
        numerosjButton.setText("Números");
        numerosjButton.setToolTipText("Número de Semanas Vendidas");
        numerosjButton.setFocusable(false);
        numerosjButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        numerosjButton.setMaximumSize(new java.awt.Dimension(80, 90));
        numerosjButton.setMinimumSize(new java.awt.Dimension(80, 90));
        numerosjButton.setPreferredSize(new java.awt.Dimension(80, 90));
        numerosjButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        numerosjButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                numerosjButtonActionPerformed(evt);
            }
        });
        BarradeTarefasjToolBar3.add(numerosjButton);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(nomeClientejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 384, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(numeroFichasjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(29, 29, 29))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(numeroFichasjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getCursosAdicionar()==1){
            if (listaCambio!=null){
                new FrmFichaCursos(0, usuarioLogadoBean, this, listaCambio.get(0).getData());
            }else {
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getCursosEditar() == 1) {
            ...
            if (linha >= 0) {
                new FrmFichaCursos(listaVendas.get(linha).getIdvendas(), usuarioLogadoBean, this, listaCambio.get(0).getData());
            }
        } else {
    ...
    private void excluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirjButtonActionPerformed
        ...
        if (linha>=0){
            ...
            if (resultado) {
                ...
                String curso = listaVendas.get(linha).getNomeCurso();
                String motivo = JOptionPane.showInputDialog("Motivo do Cancelamento");
                CancelarVenda(listaVendas.get(linha).getIdvendas(), listaVendas.get(linha).getNomeCliente(), listaVendas.get(linha).getObstm(), Formatacao.ConvercaoDataPadrao(listaVendas.get(linha).getDataInicio()), motivo);
                JOptionPane.showMessageDialog(rootPane, "Ficha de Curso Cancelada");
    ...
    private void vendasCursojTableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_vendasCursojTableKeyPressed
        if (evt.getKeyCode() == evt.VK_F1) {
            ...
            if (nlinha >= 0) {
                ...
                List<Controlecursos> listaControle = cursosController.consultarControleCursosList(listaVendas.get(nlinha).getIdvendas());
                if (listaControle == null) {
                    Controlecursos controle = new Controlecursos();
                    controle = new Controlecursos();
                    controle.setVendas(listaVendas.get(nlinha).getIdvendas());
    ...
    private void numerosjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_numerosjButtonActionPerformed
       if (listaVendas!=null){
           int numeroSemanas=0;
           for (int i=0;listaVendas.size()>i;i++){
               numeroSemanas = numeroSemanas + listaVendas.get(i).getNumerosenamas();
           }
           JOptionPane.showMessageDialog(rootPane, "Nº Semanas Vendidas = " + numeroSemanas);
       }
    }//GEN-LAST:event_numerosjButtonActionPerformed
    ...
    * @param args the command line arguments
    ...
    private javax.swing.JButton numerosjButton;
    ...
    public void carregarModelVendas(){
        ...
        if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            sql = "Select v from Viewvendascurso v where v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' and v.situacao<>'Cancelada' order by v.dataVenda";
        }else {
            sql = "Select v from Viewvendascurso v where v.idUnidade=" + usuarioLogadoBean.getUnidadeNegocio().getIdunidadeNegocio() +  
        ...
        listaVendas = vendasController.listaViewVendasCrusos(sql);
        if (listaVendas==null){
            listaVendas = new ArrayList<Viewvendascurso>();
        }
    ...
    public void CancelarVenda(int idVenda, String nomeCliente, String obsTM, String dataInicio, String motivo){
        VendasController vendasController = new VendasController();
        ...
        if(venda!=null){
            ...
            Fornecedor fornecedor = fornecedorController.consultar(venda.getFornecedor());
             Formatacao.emitirEmailGerencial(nomeCliente, usuarioLogadoBean.getUnidadeNegocio().getNomeFantasia(), 
                ...
                fornecedor.getNome(),  obsTM, dataInicio, " ", tipoVenda, motivo);
    ...
    public void imprimirFichaCurso(){
            String url = null;
            if (listaVendas.get(linha).getHabilitarsegundocurso().equalsIgnoreCase("N")){
                url = ("telas/Cursos/Relatorios/FichaCursoPagina01.jasper");
            }else url = ("telas/Cursos/Relatorios/FichaCurso2Pagina01.jasper");
            Map parameters = new HashMap();
            try {
    ...
    public void imprimirContratoCurso(){
            String url = null;
            if (listaVendas.get(linha).getHabilitarsegundocurso().equalsIgnoreCase("N")){
                url = ("telas/Cursos/Relatorios/contratoCursoPagina01.jasper");
            }else url = ("telas/Cursos/Relatorios/contratoCurso2Pagina01.jasper");
            Map parameters = new HashMap();
            try {
                parameters.put("idvendas", listaVendas.get(linha).getIdvendas());
                parameters.put("SUBREPORT_DIR","telas/Cursos/Relatorios/");
