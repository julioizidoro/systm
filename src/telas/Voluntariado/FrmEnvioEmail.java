...
public class FrmEnvioEmail extends javax.swing.JFrame {
    ...
    private void gerarFicha() {
        ...
        String url = ("telas/Cursos/Relatorios/FichaCursoPagina01.jasper");
        Map parameters = new HashMap();
        try {
            parameters.put("idvendas", this.venda.getIdvendas());
    ...
    public void gerarContrato(){
        ...
        String url = ("telas/Cursos/Relatorios/contratoCursoPagina01.jasper");
            Map parameters = new HashMap();
            try {
                parameters.put("idvendas", this.venda.getIdvendas());
                parameters.put("SUBREPORT_DIR","telas/Cursos/Relatorios/");
    ...
    public void gerarRecibo(){
        ...
        Formapagamento forma = formaPagamentoController.consultar(this.venda.getIdvendas());
