 ...
 * @author Wolverine
 */
public class FrmConsultarVoluntariado extends javax.swing.JFrame implements IConsultaVoluntariado{
     ...
     */
    public FrmConsultarVoluntariado(UsuarioLogadoBean usuarioLogadoBean, List<Cambio> listaCambio) {
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Fichas de Voluntáriado");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(nomeClientejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 235, Short.MAX_VALUE)
                        .addComponent(numeroFichasjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(35, 35, 35))))
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getCursosAdicionar()==1){
            if (listaCambio!=null){
                new FrmFichaVoluntariado01(0, usuarioLogadoBean, this, listaCambio.get(0).getData());
            }else {
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getCursosEditar() == 1) {
            ...
            if (linha >= 0) {
                new FrmFichaVoluntariado01(listaVendas.get(linha).getIdvendas(), usuarioLogadoBean, this, listaCambio.get(0).getData());
            }
        } else {
    ...
    private void excluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirjButtonActionPerformed
        ...
        if (linha>=0){
            ...
            if (resultado) {
                ...
                String curso = listaVendas.get(linha).getCurso();
                ...
                JOptionPane.showMessageDialog(rootPane, "Ficha de Voluntáriado Cancelada");
    ...
    * @param args the command line arguments
    ...
    public void carregarModelVendas(){
        ...
        String sql = null;
         if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            sql = "Select v from Viewvendasvoluntariado v where v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' and v.situacao<>'Cancelada' order by v.dataVenda";
        }else {
            sql = "Select v from Viewvendasvoluntariado v where v.idUnidade=" + usuarioLogadoBean.getUnidadeNegocio().getIdunidadeNegocio() +  
        ...
        listaVendas = vendasController.listaViewVendasVoluntariado(sql);
        if (listaVendas==null){
            listaVendas = new ArrayList<Viewvendasvoluntariado>();
        }
    ...
    public void excluirCursos(int idVenda){
        ...
        Voluntariado voluntariado = voluntariadoController.consultar(idVenda);
...
//                
//            }
            voluntariadoController.excluir(voluntariado.getIdvoluntariado());
        }
    }
    ...
    public void imprimirFicha(){
            String url = ("telas/Voluntariado/Relatorios/FichaVoluntariadoPagina01.jasper");
            Map parameters = new HashMap();
            try {
                parameters.put("idvendas", listaVendas.get(linha).getIdvendas());
                parameters.put("SUBREPORT_DIR", "telas/Voluntariado/Relatorios/");
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Não foi possível gerar o relatório " + ex);
                ex.printStackTrace();
            }
    ...
    public void imprimirContrato(){
            String url = ("telas/Voluntariado/Relatorios/contratoVoluntariadoPagina01.jasper");
            Map parameters = new HashMap();
            try {
                parameters.put("idvendas", listaVendas.get(linha).getIdvendas());
                parameters.put("SUBREPORT_DIR","telas/Voluntariado/Relatorios/");
    ...
    public void setPesquisa(Cliente cliente, Unidadenegocio unidade, Usuario usuario, Date dataInicial, Date dataFinal, String situacao) {
        String sql = null;
        sql = "Select v from Viewvendasvoluntariado v where ";
