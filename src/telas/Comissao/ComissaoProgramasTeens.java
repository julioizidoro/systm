...
import telas.ProgramasTeens.ProdutoOrcamentoBean;
 ...
 * @author Wolverine
 */
public class ComissaoProgramasTeens {
    ...
    public ComissaoProgramasTeens(UsuarioLogadoBean usuarioLogadoBean, Vendas venda, List<ProdutoOrcamentoBean> listaProdutosGeral, float valorCambio, Valoresprogramasteens valoresprogramasteens, List<Parcelamentopagamento> listaParcelamento, Date dataInicioPrograma, Date dataInicio,Vendascomissao vendascomissao) {
    ...
    public void getParametros(){
        ...
        produto = produtoController.consultar(usuarioLogadoBean.getParametrosprodutos().getProgramasTeens());
    }
    ...
    public void calcularComissaoLoja() {
        ...
        if (valorBruto > 0) {
            if (usuarioLogadoBean.getUnidadeNegocio().getTipo().equalsIgnoreCase("Premium")) {
                ...
                comissaoLoja = valoresProgramasTeens.getComissaoexpress() * cambioVenda;
            }
