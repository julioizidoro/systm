...
public class ComissaoAuPair {
    ...
    public ComissaoAuPair(UsuarioLogadoBean usuarioLogadoBean, Vendas venda, List<ProdutoOrcamentoBean> listaProdutosGeral, float valorCambio, Valoresaupair valoresaupair, List<Parcelamentopagamento> listaParcelamento, Date dataInicioPrograma, Date dataInicio,Vendascomissao vendascomissao) {
    ...
    public void conversaoValoresAupair(){
        valorGross = valoresAupair.getValorgross() * cambioVenda;
    }
    ...
    public void getParametros(){
        ...
        produto = produtoController.consultar(usuarioLogadoBean.getParametrosprodutos().getAupair());
    }
    ...
    public void calcularComissaoLoja() {
        ...
        if (valorBruto > 0) {
            if (usuarioLogadoBean.getUnidadeNegocio().getTipo().equalsIgnoreCase("Premium")) {
                comissaoLoja = valoresAupair.getComissaopremium() * cambioVenda;
            } else {
                comissaoLoja = valoresAupair.getComissaoexpress() * cambioVenda;
            }
