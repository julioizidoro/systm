...
import telas.Trainee.ProdutoOrcamentoBean;
...
public class ComissaoTrainee {
    ...
    public ComissaoTrainee(UsuarioLogadoBean usuarioLogadoBean, Vendas venda, List<ProdutoOrcamentoBean> listaProdutosGeral, float valorCambio, Valorestrainee valoretrainee, List<Parcelamentopagamento> listaParcelamento, Date dataInicioPrograma, Date dataInicio) {
        this.venda = venda;
    ...
    public void getParametros(){
        ...
        produto = produtoController.consultar(usuarioLogadoBean.getParametrosprodutos().getTrainee());
    }
    ...
    public void calcularComissaoLoja() {
        ...
        if (valorBruto > 0) {
            if (usuarioLogadoBean.getUnidadeNegocio().getTipo().equalsIgnoreCase("Premium")) {
                comissaoLoja = valoresTrainee.getComissaopremium() * cambioVenda;
            } else {
                comissaoLoja = valoresTrainee.getComissaoexpress() * cambioVenda;
            }
