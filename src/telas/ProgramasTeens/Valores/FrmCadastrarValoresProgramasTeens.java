 ...
 * @author Wolverine
 */
public class FrmCadastrarValoresProgramasTeens extends javax.swing.JFrame implements IValoresProgramasTeens{
     ...
     */
    public FrmCadastrarValoresProgramasTeens(UsuarioLogadoBean usuarioLogadoBean, Valoresprogramasteens valores) {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastrar Valores Programas Teens");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        new FrmConsultaFornecedor(usuarioLogadoBean, this, parametrosprodutos.getProgramasTeens());
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String msg = validarDados();
        if (msg.length() < 5) {
            valores.setInicio(duracaojTextField.getText());
            Moedas moeda = (Moedas) moedasVendasjComboBox.getSelectedItem();
            valores.setMoedas(moeda);
            valores.setFornecedorcidade(fornecedorCidade);
            valores.setFornecedorcidade(fornecedorCidade);
            valores.setValornet(Formatacao.formatarStringfloat(valornetjTextField.getText()));
            valores.setValorgross(Formatacao.formatarStringfloat(valorgrossjTextField.getText()));
            valores.setComissaoexpress(Formatacao.formatarStringfloat(valorExpressjTextField.getText()));
            valores.setComissaopremium(Formatacao.formatarStringfloat(valorPremiumjTextField.getText()));
            Produtosorcamento produto = (Produtosorcamento) produtojComboBox.getSelectedItem();
            valores.setProdutosorcamento(produto);
            ValorProgramasTeensController valorProgramasTeensController = new ValorProgramasTeensController();
            valorProgramasTeensController.salvar(valores);
            this.dispose();
        } else {
    ...
    public void iniciaizarDados(){
        if (valores!=null){
            duracaojTextField.setText(valores.getInicio());
            valornetjTextField.setText(Formatacao.formatarFloatString(valores.getValornet()));
            valornetjTextField.setText(Formatacao.formatarFloatString(valores.getValorgross()));
            valorExpressjTextField.setText(Formatacao.formatarFloatString(valores.getComissaoexpress()));
            valorPremiumjTextField.setText(Formatacao.formatarFloatString(valores.getComissaopremium()));
            moedasVendasjComboBox.setSelectedItem(valores.getMoedas());
            produtojComboBox.setSelectedItem(valores.getProdutosorcamento());
        }else {
            valores = new Valoresprogramasteens();
        }
    }
