...
public class ConsultaVendasTableModel extends AbstractTableModel{
    ...
    private List<Viewvendasprogramasteens> listaVendas;
    private String[] colunas ={"Situação", "Nome do Cliente", "Data Inscrição", "Curso", "Unidade", "Consultor"};

    public ConsultaVendasTableModel(List<Viewvendasprogramasteens> listaVendas) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        if (columnIndex==0){
            ...
            return listaVendas.get(rowIndex).getNomeCurso();
