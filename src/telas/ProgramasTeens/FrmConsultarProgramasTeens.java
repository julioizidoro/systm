 ...
 * @author Wolverine
 */
public class FrmConsultarProgramasTeens extends javax.swing.JFrame implements IConsultaProgramasTeens{
     ...
     */
    public FrmConsultarProgramasTeens(UsuarioLogadoBean usuarioLogadoBean, List<Cambio> listaCambio) {
    ...
    private void initComponents() {
        ...
        setTitle("Consulta Fichas de Programas Teens");
        ...
        AdicionarjButton3.setToolTipText("Nova Ficha Programa Teens");
        ...
        EditarjButton.setToolTipText("Editar Ficha Programa Teens");
        ...
        excluirjButton.setToolTipText("Cancelar Ficha Programa Teens");
        ...
        imprimirjButton1.setToolTipText("Pesquisar Ficha Programas Teens");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(nomeClientejTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(numeroFichasjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(34, 34, 34))))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void AdicionarjButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdicionarjButton3ActionPerformed
        if (usuarioLogadoBean.getAcesso().getProgramasTeensAdicionar()==1){
            if (listaCambio!=null){
                new FrmFichaProgramasTeens(0, usuarioLogadoBean, this, listaCambio.get(0).getData());
            }else {
    ...
    private void EditarjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditarjButtonActionPerformed
        if (usuarioLogadoBean.getAcesso().getProgramasTeensEditar() == 1) {
            int linha = vendasCursojTable.getSelectedRow();
            if (linha >= 0) {
                new FrmFichaProgramasTeens(listaVendas.get(linha).getIdVendas(), usuarioLogadoBean, this, listaCambio.get(0).getData());
            }
        } else {
    ...
    private void excluirjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirjButtonActionPerformed
        ...
        if (linha >= 0) {
            ...
            if (resultado) {
                ...
                CancelarVenda(listaVendas.get(linha).getIdVendas(), listaVendas.get(linha).getNomeCliente(), Formatacao.ConvercaoDataPadrao(listaVendas.get(linha).getDataInicioCurso()), motivo, listaVendas.get(linha).getNomeEscola());
                JOptionPane.showMessageDialog(rootPane, "Ficha de Programas Teens Cancelada");
    ...
    private void nomeClientejTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nomeClientejTextFieldKeyPressed
        ...
        if (evt.getKeyCode() == evt.VK_F1) {
            ...
            for (int i = 0; i < listaVendas.size(); i++) {
                Controleprogramasteens controle = programasTeensController.consultarControleProgramasTeens(listaVendas.get(i).getIdVendas());
                if (controle == null) {
    ...
    public void carregarModelVendas(){
        ...
        String sql = null;
         if (usuarioLogadoBean.getUsuario().getTipo().equalsIgnoreCase("Gerencial")){
            sql = "Select v from Viewvendasprogramasteens v where v.nomeCliente like '%" + nomeClientejTextField.getText() + "%' and v.situacao<>'Cancelada' order by v.dataVenda";
        }else {
            sql = "Select v from Viewvendasprogramasteens v where v.idunidadeNegocio=" + usuarioLogadoBean.getUnidadeNegocio().getIdunidadeNegocio() +  
        ...
        listaVendas = vendasController.listaViewVendasProgramasTeens(sql);
        if (listaVendas==null){
            listaVendas = new ArrayList<Viewvendasprogramasteens>();
        }
    ...
    public void excluirProgramaTeens(int idVenda){
        ProgramasTeensController programasTeensController = new ProgramasTeensController();
        Programasteens programasteens = programasTeensController.consultarProgramasteens(idVenda);
        if (programasteens!=null){
            Controleprogramasteens controle = programasTeensController.consultarControleProgramasTeens(idVenda);
            if (controle!=null){
                programasTeensController.excluirControleProgramasTeens(controle);
            }
            programasTeensController.excluir(programasteens.getIdprogramasTeens());
        }
    }
    ...
    public void setImpressao(boolean ficha, boolean contrato, boolean recibo, boolean visto) {
        if (ficha){
            imprimirFichaProgramaTeens();
        }
        if (contrato){
            imprimirContratoProgramasTeens();
        }   
        if (recibo){
            imprimirRecibo();
        }
    ...
    public void imprimirFichaProgramaTeens(){
    ...
    public void imprimirContratoProgramasTeens(){
    ...
    public void setPesquisa(Cliente cliente, Unidadenegocio unidade, Usuario usuario, Date dataInicial, Date dataFinal, String situacao) {
        String sql = null;
        sql = "Select v from Viewvendasprogramasteens v where ";
    ...
    public void CancelarVenda(int idVenda, String nomeCliente, String dataInicio, String motivo, String fornecedor){
        VendasController vendasController = new VendasController();
        ...
        if(venda!=null){
            ...
            if (venda.getVendasMatriz().equalsIgnoreCase("S")) {
             ...
             Formatacao.emitirEmailGerencial(nomeCliente, usuarioLogadoBean.getUnidadeNegocio().getNomeFantasia(), 
                ...
                fornecedor,  venda.getObstm(), dataInicio, " ", tipoVenda, motivo);
            ...
            ProgramasTeensController programasTeensController = new ProgramasTeensController();
            List<Controleprogramasteens> listaControle = programasTeensController.consultarControleProgramasTeensList(venda.getIdvendas());
            if (listaControle!=null){
                for(int i=0;i<listaControle.size();i++){
                    Controleprogramasteens controle = listaControle.get(i);
