 ...
 */
@Entity
@Table(name = "viewcontroleaupair")
public class Viewcontroleaupair implements Serializable {
    private static final long serialVersionUID = 1L;
    @Basic(optional = false)
    @NotNull
    @Column(name = "idcontroleAupair")
    @Id
    private int idcontroleAupair;
    ...
    public Viewcontroleaupair() {
    }

    public int getIdcontroleAupair() {
        return idcontroleAupair;
    }

    public void setIdcontroleAupair(int idcontroleAupair) {
