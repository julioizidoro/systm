 ...
 */
@Entity
@Table(name = "valoresprogramasteens")public class Valoresprogramasteens implements Serializable {
    ...
    public String toString() {
        return "model.Valoresprogramasteens[ idvaloresprogramasteens=" + idvaloresprogramasteens + " ]";
    }
}
